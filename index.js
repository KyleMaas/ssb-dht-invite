...
function makeStart(sbot, codesDB, channelsSource) {
...
function makeCreate(sbot, codesDB, channelsSource) {
...
function makeUse(sbot, codesDB) {
  return function use(req, cb) {
    //#region preconditions
    if (!codesDB) {
      return cb(
...
function makeAccept(sbot) {
  return function accept(invite, cb) {
    var seed, remoteId
...
module.exports = {
  ...
  init: function(sbot, config) {
    ...
    return {
      start: makeStart(sbot, codesDB, channelsSource),
      create: makeCreate(sbot, codesDB, channelsSource),
      use: makeUse(sbot, codesDB),
      channels: function() {
        return channelsSource
      },
      accept: makeAccept(sbot),
    }
  },
}
